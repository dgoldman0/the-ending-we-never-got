...
testcase comparisons:
    ...
    click id "page_next"
    pause 0.3
    run SetVariable("composition", "caption")
    pause 0.2
    screenshot "comparisons/study-01-caption.png"
    run SetVariable("composition", "column")
    pause 0.2
    screenshot "comparisons/study-02-column.png"
    run SetVariable("composition", "folio")
    pause 0.2
    screenshot "comparisons/study-03-folio.png"
