...
**Current status: opening rebuild in progress.** The user rejected the first two presentations, then authorized production after the requirements discussion. The replacement [opening sequence](../art/opening-sequence/README.md) adds beat-specific actors, speaker-positioned dialogue, a workable remote lever station and separate action illustrations. S001 is integrated; S002–S003 and the connected experience are under production and review. The rest of the route is unfinished. See [the redesign gates](../presentation-redesign.md) and [review observations](../art/opening-sequence/review/production-review.md); technical passes are not visual approval.
