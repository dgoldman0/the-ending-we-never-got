        ...
        if not available_details():
            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        add 'art/cg/detail-drawing.png' xysize (760, 183)
                    vbox:
                        xsize 760 spacing 16
                        text 'On the other side of the silence' font 'fonts/EBGaramond12-Regular.ttf' size 40
                        add 'art/cg/detail-phone.png' xysize (540, 234)
                if unfold:
            ...
            hbox:
                ...
                vbox:
                    ...
                    if selected_detail == 'drawing':
                        add detail_item['image'] xysize (1050, 253)
                    else:
                        add detail_item['image'] xysize (900, 390)
            ...
            hbox:
                ...
                fixed:
                    ...
                    add 'art/cg/mothers-chair.png' xysize (1120, 630)
                    button:
                        xpos 445 ypos 519 xsize 205 ysize 54
                    ...
                    button:
                        xpos 830 ypos 570 xsize 218 ysize 54
                        background Solid('#0b1419de') hover_background Solid('#574b35ef')
            ...
            vbox:
                ...
                hbox:
                    ...
                    button:
                        ...
                        vbox:
                            spacing 23
                            add 'art/cg/detail-drawing.png' xysize (650, 157)
                    ...
                    button:
                        ...
                        vbox:
                            spacing 20
                            add 'art/cg/detail-phone.png' xysize (470, 203)
