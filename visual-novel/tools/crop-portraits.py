...
GIMP then works on each crop (tools/crop-portraits.scm is generated):
  ...
  flattened crops to renpy/game/art/cast/<name>.png, and the facing of each
  ...
  speaker faces the listener).
    ...
    python3 visual-novel/tools/grade-light.py --portraits --force
...
SCRIPT = VN / 'tools/crop-portraits.scm'
