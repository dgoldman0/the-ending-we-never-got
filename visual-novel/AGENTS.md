...
- **Latest wardrobe correction:** the user questioned Tessa's entire Saint clothing direction, including working/campaign clothes. The modern-looking jacket/shirt/trousers system, formal trouser ensemble and cardigan variant are under redesign. Do not propagate them from existing keys or the convoy study. Read [the wardrobe audit and proposal](art/character-keys/tessa/wardrobe-redesign.md); solve the whole silhouette, construction and Saint identity before more costume renders. The screenplay's “coat” does not require a modern jacket. The proposal is not a user-selected design. The arrival clothes, selected facial likeness, chronological ages and injury continuity are separate from this wardrobe correction.
