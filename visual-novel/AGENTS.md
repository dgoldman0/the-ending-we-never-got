...
- **Lever placement correction:** the user rejected the control immediately beside the doorway because access and operation obstruct the opening. That assistant-authored position is superseded. Establish the scholar's approach, standing space, full lever travel and sight line alongside Tessa's attempted return route in a room plan and sequential storyboard before rendering the opening again. A reachable handle in a still is insufficient. Exact replacement geometry remains to be designed; do not change the screenplay to justify the old placement.
