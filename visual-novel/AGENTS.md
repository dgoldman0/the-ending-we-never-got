...
- The **player** can investigate and learn that humans started the ancient war through the **first Saint summoning**. Tessa's summoning is a later event. Do not transfer that knowledge to Tessa or the other original cast through dialogue, decisions or inventory without a separate story decision. Specific ancient events and evidence still require development; the [investigation sketch](investigation.md) is a proposal, not already-authored historical canon.
