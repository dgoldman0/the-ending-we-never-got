...
Status: **REJECTED, UNFINISHED CHECKPOINT — 16 September 2026.** The user rejected both the first playable presentation and its partial replacement. Substantial scene, character-performance and UI/UX work remains. **Look closer / Threads** is the accepted reader-discovery direction; its first-night prototype is not an approved presentation. Read the [presentation audit and completion gates](presentation-redesign.md) and [interaction contract](investigation.md) before extending the game. Current instruction: preserve the checkpoint and discuss the realignment before further production.
...
The rejected replacement contains two beat-specific CGs, revised reading/title/utility screens and the first-night Look closer / Threads prototype. See [coverage and review](art/presentation-v2/review.md). Disabling the old character cutouts left narrated and spoken scenes without their participants. That is an unresolved presentation regression, not acceptable replacement coverage. Speaker-positioned dialogue boxes, complete acting coverage, a physically workable summoning opening and a convincing visual language still need production and whole-sequence review.
