...
Status: **WORKING REALIGNMENT, INCOMPLETE ADAPTATION — 16 September 2026.** The user rejected both the first playable presentation and its partial replacements; checkpoint `f3acb5e` preserves the latest rejected S001–S003 revision. Version 0.3.2 revises its lighting and interface and adds the requested persistent Intense/Softened lighting choice. Substantial scene and character-performance work remains. **Look closer / Threads** is the accepted reader-discovery direction; its first-night prototype is not an approved presentation. Read the [presentation audit and completion gates](presentation-redesign.md), [current review](art/opening-sequence/review/realignment-review.md) and [interaction contract](investigation.md) before extending the game.

The existing build remains a functional inspection baseline: all 58 original screenplay scenes, ten chapters and the complete ending through **“Do you wish to save Tessa?”** are traversable. Its five mandatory discovery invitations and six card/quiz inquiries have been removed; the story now runs continuously between chapter titles. Run [play.sh](play.sh); see [build instructions](renpy/README.md) and [technical QA](renpy/QA.md). Technical completion does not certify the presentation.
...
The current opening maps 66 reading states with state-specific CGs, transparent cast performances, speaker-positioned dialogue and the first-night Look closer / Threads connection. The renewed shared exposure and painted interface have been inspected in actual play; they remain working production, not user-approved presentation. **Settings → Lighting → Softened** restores less intense images throughout the current illustrated portion without changing the story or save state. [Lighting provenance](art/lighting/README.md) records the recovered exports and GIMP alternates. The [route ledger](art/route-coverage.md) explicitly retains the unresolved cast gap in S004–S005 and missing later illustration work.
