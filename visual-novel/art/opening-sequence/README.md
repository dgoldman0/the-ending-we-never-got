...
Summoning room: 12 m east–west by 9 m north–south. The arch is in the north wall, centred at x=6, 2.4 m wide. The circle meets its threshold. Tessa lands at (6,0.6); dropped groceries remain there. Her direct return to (6,0) stays clear. The scholar's lever is on the east wall at (11.5,2), with a dedicated operating bay from x=9.5–12 and y=1–3.5. Its handle sweeps within that bay. The scholar faces west/southwest and can see the arch. He is already at the station when she arrives, avoiding any implausible crossing of her path. No control is attached to the doorway jamb.

Spectators initially kneel mainly at x=2–8, y=3.5–5.5, facing the arch. Senn's approach passes the crowd's eastern edge toward (7,2). The pleading woman catches his sleeve on that approach. Guards subsequently occupy the approach to the control bay, around (8.5,2.5); they block Tessa from the scholar, not the original route back through the portal. The stretcher gallery runs east–west across y=6.5–8.5 with a clear 2 m aisle. Mara enters from that gallery and guides Tessa aside when the porters call. These dimensions support staging, not new spoken story facts.

Initial camera looks northeast from the southwest quarter: portal left of centre, station well to the right on a perpendicular wall. Keep a visible stretch of wall/floor between them. Conversation camera is closer to the sealed arch; the station remains off to the right. Preserve screen direction. Earth has ordinary utilitarian glass, shop shelving and cool fluorescent light, distinct from warm limestone, celadon details and botanical carving. Dawn glare fills the temple and affects people; the street keeps its own exposure.

Apartment: high window on the west wall; one chair at that window until line 108. Entry on the east wall opens into a lit guarded hall. Table between window and entrance, offset south so the direct walking route stays open; second chair at table. Bed/wardrobe on the north wall, offered ivory dress below wardrobe. Unlit hearth, cream plaster, heavy curtains, worn rug. Tessa moves window → table/door → table; Mara remains near the entry, places the covered plate on the nearby table, then physically blocks the threshold. The candle returns to the table before the cloak falls. Mara takes the cloak out; door shuts; the window chair moves against it. Drawing uses the second chair. The apartment is dark, with cool window light and a small candle pool, not a bright studio.
