...
Updated 25 September 2026, after Claude checked GPT's work through chapter 07 (S043). The game takes new art without code changes: a file saved at its listed path appears in play once Claude has cropped and graded it. This file says what GPT makes next, where it stops, and what is queued behind that stop.
...
**Checked, 25 September (Claude), before integration:** everything delivered through chapter 07: the S006, S008, S011 and S025 gap paintings, the two repairs, and chapters 05, 06 and 07 (S026–S043, 44 paintings with their key moments), played in a copy of the game. The work is strong: faces and costumes stay consistent, Iven's coat is brown throughout, and Harrow reads clearly from the crossing to the coat across Tessa's knees. The new drawing close-up is sharp with a clear tear. The faults are listed as items 7–11 under **Repaints found during this batch**; do those first, then **resume part E at chapter 08 (S044)**. Claude integrates what has arrived and handles the interface side (text placement over the S028 splint and the S029 chart, and the scene heading on long first passages).
...
Items 1–6 (the S011 heron, the two S008 paintings, the S006 warden, the S025 report, the S004 sling and the S002 drawing close-up) are done. Do these before chapter 08. Each is a correction to a delivered painting: keep its composition, camera, light and every other figure, change only what is listed, and save it at the same path (item 7 goes in `art/repaints/`). A note in the commit is enough.
