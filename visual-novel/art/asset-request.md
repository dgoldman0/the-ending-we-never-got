...
39. **Crossbows, not rifles.** Serat's crossbow in `s018-gray-scar-ferry-approach.png` and `s020-gray-scar-riverbank.png`, the escorts' in S018, and the spent crossbow Lucan leans on the gatepost in `s021-rescue.png` (a double tube on a stand, like a rifle on a bipod) have a stock and a barrel but no bow and no string, like Lucan's in S051 (item 16). A crossbow has a bow across its front and a string.
40. **Horns at Gray Scar.** Serat and the whole northern party in `s018-gray-scar-ferry-approach.png` (Lucan's own horn barely shows there, at his introduction), the northern woman Serat supports in `s019-gray-scar-ferryhouse.png`, and the northern families in `s020-gray-scar-riverbank.png` have no horns. Every northerner has them (self-check item 7).
...
45. **S014, Elin and Renn.** Elin at the door in `s014-boots-and-cap.png` has lighter skin and smooth hair in a bun; her design and S012/S013 give her deep-brown skin and tightly curled hair in a short twist. Renn, about six, is drawn as tall and as old as Ada, who is eight, in both S014 paintings and in `s011-sanctuary.png`.
